...
public class Servidor implements ServicoExecucao{
	...
	public static void main(String[] args) {
		...
		try{
			servico = (ServicoExecucao) UnicastRemoteObject.exportObject(servidor, 0);
	
			
			Registry registry = LocateRegistry.createRegistry(1818);
			registry.rebind(ServicoExecucao.NOME_SERVICO, servico);
	...
	public <R> R executar(Tarefa<R> tarefa) throws RemoteException {
		...
		System.out.println("Recebendo tarefa para executar");
